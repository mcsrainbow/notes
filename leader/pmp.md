...
- 运营：持续、重复、流程化的工作。例如，财务部门每天都要记账，每周都要处理报销，每个月都要报税。这些工作过去这么做，现在这么做，以后还得这么做，这就是运营。
...
我们在实践中要根据项目的特点选择恰当的项目管理方式。例如，互联网软件项目的需求未知性强、变化快，要求团队快速响应、快速交付，所以团队宜采用敏捷方法；而工程建设项目涉及的专业多、工艺复杂、变更成本巨大，所以团队宜采取预测型的开发方法。
...
2. 防微杜渐
   ...
   例如一个软件开发项目，团队按计划到今天应该完成20个功能点的开发，而实际只完成了18个，这就出现了进度偏差，团队就要想办法采取措施及时纠正，不能让偏差继续扩大。如果最后偏差大到失控，那就无法挽回了。  
3. 资源集成
