...
学习内容平均留存率和学习方式关系极大，如果采用听课、阅读这种被动的学习方式，那么留存率就会少得可怜如果采用讨论、实践、传授这些主动的学习方式，那么留存率就会显著提高。
...
边际收益递减规律：  
刚开始增加资源投人时收益增加很显著继续增加资源投人，收益并不会等比例增加，收益增幅会越来越小  
...
问题和风险可能会相互转化：风险发生了，就成了问题问题出现预示着这类情况还有可能再次出现，这就是风险。  
...
| 2    | 项目开工会（开踢会） Kick-off Meeting | 计划完成后、执行开始前多阶段项目每阶段执行前一次 | 团队对项目或阶段的目标、范围等达成一致                                     | 项目团队                                 | ☆☆☆☆☆  |
...
3. 项目管理计划与项目文件的区别是什么？  
   ...
   项目管理计划是规则文件，一般不轻易变更而项目文件会随着项目的执行和需求的变化频繁变更。  
...
5. 动用应急储备是否需要走整体变更控制程序？  
   ...
   如果变更影响项目基准，就由变更控制委员会批准如果不影响项目基准，就由项目经理批准。  
...
15. 问题和风险有什么区别？  
    ...
    例如，服务器可能会宕机，这是风险而服务器宕机了，这就是问题。  
    问题和风险可能会相互转化：风险发生了，就成了问题问题可能预示着还有可能再出现，就是风险。  
...
28. 变更必须由CCB 批准吗？  
    不一定，变更由谁批准取决于变更是否影响项目基准。如果变更影响基准，必须由 CCB批准如果变更不影响基准，项目经理就可以批准。  
...
33. 控制账户中包含成本应急储备和管理储备吗？  
    ...
    应急储备用于应对已知一未知风险，由项目经理管理而管理储备用于应对未知一未知风险，由高级管理层管理。  
34. 完工预算和项目预算一样吗？  
...
42. 总价类合同与成本类合同的主要区别是什么？  
    成本类合同的特征是成本实报实销，费用另外按规则约定总价类合同的特征是总价（包括成本和费用）有限额或总价有限制规则。  
43. 工料合同用于什么情况？  
...
57. 假设条件和制约因素的区别是什么？  
    制约因素是客观存在的，而且是确定的假设条件是主观判断的，而且是不确定的。  
    例如，一个项目只有30天时间，且团队只有5个人，这些就是制约因素不会再有需求变更，不会发生人员离职风险等，这些属于假设条件。  
    如果适当放宽制约因素，就可以消除一些风险如果适当收紧假设条件，就会暴露更多风险。  
...
77. 采购经理和项目经理当中，谁对采购文件的质量负责？  
    ...
    项目经理对（采购）工作说明书负责，对外包的工作进行定义和描述采购经理对采购文件的合法、合规负责。  
...
1. 组织要转型敏捷，PM 需要评估组织文化、制度和员工能力等或者通过介绍敏捷的好处获得干系人的支持或者要求管理层实施敏捷或者选择一个项目进行试点
2. 发起人/组织想要启动新项目/开发新产品，PM 首先要获得商业论证或者制定项目章程，或者使用组织过程资产和事业环境因素
3. 可行性→商业论证
4. 可视化→看板
5. 工作流→看板
6. 需求不明确、变更比较多、需要研究的项目→敏捷
7. 混合型生命周期作为组织转型的过渡，具体开发过程采用敏捷方法
8. 题干描述中出现"迭代"、"冲刺"、"产品待办列表"、"用户故事"、"PO 产品负责人"、"开发团队"等词汇，考虑敏捷方法
9. PM 和敏捷教练通常是一个人，特殊声明可以是两个人，此时项目经理尚未完成转型，所以外部聘请教练引导组织/团队实施敏捷
10. 合规性要求必须要满足，要满足合规性需求，一般需要对于合规性要求进行分类，通常只分析合规性的后果，而非合规性的代价
11. 在其他国家实施项目→考虑当地的法律法规
12. 关键干系人的要求不符合组织流程/制度→咨询 PMO
13. 有利于未来项目/运营→OPA
14. 谁引发的问题，PM 需要首先与其进行沟通来解决问题
15. 干系人之间有冲突，无法达成一致→一般需要开会来讨论达成一致
16. 题干描述存在多个问题，单选题目要选择能解决所有问题的选项，多选题可以通过多个选项分别解决各个问题
17. 预测型项目，严格管理变更，严格执行整体变更控制流程/变更控制程序敏捷项目拥抱变更，迅速响应及时适应
18. 类似估算。长期估算→类比估算
19. 知识转移→团队成员之间的知识分享/OPA 更新
20. 项目不再创造价值→项目经理可以建议发起人取消项目
21. 项目优先选择使用组织内的资源促进通过培训使团队成员成长为 SME
22. 团队成员能力不足、缺乏技能→培训
23. 团队成员缺经验→使用组织过程资产/指导/辅导，不一定选择培训
24. 团队成员绩效差→直接与其沟通了解原因/提供支持/分析原因/制定发展计划、绩效改进计划
25. 团队成员工作有问题→私下讨论/保密讨论
26. 虚拟团队→强调沟通，考虑多样性文化而引起的包容性问题
27. 团队成员无法继续为项目工作→审查资源管理计划/评估影响，审查/更新风险登记册，提交变更请求
28. 只提到团队成员士气低落→组织团队建设
29. 因某些原因导致团队士气低落→首先要解决问题
30. 团队成员违反基本规则→强调规则，要合规
31. 冲突解决的第一责任人→冲突双方
32. 人员/实物资源的问题→通过资源管理计划解决
33. 沟通/信息传递的问题→审查或更新沟通管理计划
34. 干系人抵制/反对/不积极参与/对项目成功有影响→干系人参与计划
35. 有新的干系人→干系人分析/更新干系人登记册/
36. 一般不能选择更新风险管理计划，可以选择审查风险管理计划
37. 预测型题目，风险类题目，实在不确定，可以蒙带风险登记册的选项
38. 题干中出现供应商，优先考虑采购管理的工作内容
39. 供应商的工作出现问题，可以使用合同/协议来解决
40. 团队工作中遇到各类问题，首先做 RCA 来找原因，再制定解决方案
41. 敏捷项目的三个角色，务必各司其职，不能做其他人的工作
42. PO 负责创建和维护产品待办列表PO 确定产品开发方向PO 编写用户故事PO 对用户故事/产品待办事项进行优先级排序PO 确保产品对价值PO 创建产品路线图PO 确定发布目标、发布计划和冲刺/迭代目标
43. DT 是由跨职能团队组成，是自组织团队，可以做出技术性的决策DT 发展创建和维护迭代/冲刺待办列表DT 创建冲刺/迭代计划
44. 项目经理/项目负责人/产品负责人/敏捷教练/scrum 主管/scrum 教练/团队促进者都是项目经理，是服务型领导，工作方式包括引导、指导和引导职责包括解决障碍，创建工作环境
45. 敏捷项目质量不好，使用 DoD 或 TDD，二者同时出现优先选择 TDD
46. 敏捷项目中提倡使用 TDD 和自动化测试，也包括验收测试驱动开发和行为驱动开发
47. 技术债务→重构
48. 团队要跳过测试，可能会增加技术债务，或者评估影响再做决策
49. 每日站会目的是沟通，DT 轮流主持，并回答三个问题—昨天实际完成、今天计划完成、工作中遇到的风险/问题/障碍
50. 风险/问题/障碍有多个，要解决时需要先确定优先级排序
51. 预测型项目中：问题记录在问题日志风险记录在风险登记册
52. 敏捷项目中：问题记录在停车场区风险记录在风险板上障碍记录在障碍板上
53. 每日站会发现问题评审会议演示产品增量，获得反馈回顾会议团队讨论找原因，制定解决方案
54. 发起人不确定市场反馈/市场是否解释产品/客户无法确定真实需求/客户无法准确表达真实需求/在有限的时间内要完成产品上线/尽快交付价值→MVP
55. 多个敏捷团队在一个项目中合作→SoS（scrum of scrums）
56. 迭代的时间盒不可改变，不可延长
57. 当前迭代遇到问题，或资源被调走，迭代目标无法实现→PM 需要与 PO 沟通重新进行优先级排序，对迭代的工作进行调整